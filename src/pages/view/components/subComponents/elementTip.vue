<template>
    <div>
        <div v-show="!showToolTip" class="tipBtn">
            <el-button @click="openElementTip">Element Tip</el-button>
        </div>
        <div v-show="showToolTip" class="tip">
            <div class="close-wrap">
                <a href="javascript:;" @click="closeElementTip" class="close">X</a>
            </div>
...
export default {
    ...
    methods: {
       ...
       openElementTip(){
            ...
            IModelApp.accuSnap.onChanged.addListener(id=>{
                let param = {
                            id:id,
                            imodeltoken:JSON.stringify(IModelApp.viewManager.selectedView.view.iModel._token)
                        };
                this.getExtraParam(param);
            })
            
       },
       closeElementTip() {
            this.showToolTip = false;
            IModelApp.accuSnap.onChanged.removeListener()
       }
    }
}
</script>
